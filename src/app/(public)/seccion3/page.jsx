...
export default function Seccion3() {
  ...
  return (
    <>
        ...
        <div className="mx-auto w-full max-w-7xl px-5 md:px-8 lg:px-10">
          <RevealOnScroll>
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                <p className="text-xs uppercase tracking-[0.24em] text-[color:var(--gold-700)]/80">Casos clinicos</p>
                <h2 className="mt-4 max-w-3xl text-balance text-3xl font-light leading-tight tracking-[0.02em] sm:text-4xl lg:text-5xl">
                  Resultados reales, documentados y alineados a tu objetivo.
                </h2>
              </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[color:var(--gold-300)] bg-white text-[color:var(--ink-900)] transition duration-300 hover:bg-[color:var(--gold-50)]"
                >
          ...
          >
            {clinicalCases.map((item, index) => (
              ...
              >
                <article className="flex h-full flex-col overflow-hidden rounded-3xl border border-[color:var(--gold-100)] bg-white shadow-[0_18px_50px_-42px_rgba(63,48,24,0.22)]">
                  <div className="relative aspect-[4/5] overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.04)_0%,rgba(19,15,12,0.75)_100%)]" />
                  </div>
                  <div className="flex  justify-center p-5 sm:p-6">
                    <h3 className="text-2xl font-light leading-7 tracking-[0.02em] text-[color:var(--ink-900)]">
                      {item.title}
                    </h3>
                  </div>
                </article>
      ...
      <section id="agenda" className="scroll-mt-24 bg-[color:var(--background)] py-20 text-[color:var(--ink-900)] sm:py-24">
        <div className="mx-auto w-full max-w-7xl px-5 md:px-8 lg:px-10">
          <RevealOnScroll>
            <div className="rounded-[2rem] border border-[color:var(--gold-100)] bg-[linear-gradient(145deg,#ffffff_0%,#f7f1e6_55%,#fffaf2_100%)] px-6 py-14 text-center shadow-[0_24px_70px_-50px_rgba(63,48,24,0.25)] sm:px-10">
              <p className="text-xs uppercase tracking-[0.24em] text-[color:var(--gold-700)]/70">Agenda premium</p>
              ...
              <p className="mx-auto mt-5 max-w-2xl text-sm leading-8 tracking-[0.02em] text-[color:var(--ink-700)]/80 sm:text-base">
              ...
              <Link
                ...
                className="mt-8 inline-flex w-full max-w-xs justify-center rounded-full border border-[color:var(--gold-300)] bg-[color:var(--gold-500)] px-8 py-3 text-xs font-semibold uppercase tracking-[0.16em] text-[color:var(--ink-900)] transition duration-300 ease-out hover:bg-[color:var(--gold-300)]"
              >
                Reservar hora
              </Link>
            </div>
